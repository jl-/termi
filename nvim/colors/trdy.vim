...
let s:palette.green          = { "gui": "#09CBAA", "cterm": "114",  "cterm16": "2" }
let s:palette.yellow         = { "gui": "#ffcb6b", "cterm": "180",  "cterm16": "3" }
let s:palette.dark_yellow    = { "gui": "#F78C6C", "cterm": "173",  "cterm16": "11" }
let s:palette.blue           = { "gui": "#3da6ee", "cterm": "39",   "cterm16": "4" }
let s:palette.darkturquoise  = { "gui": "#00CED1", "cterm": "39",   "cterm16": "4" }
let s:palette.purple         = { "gui": "#B877DB", "cterm": "170",  "cterm16": "5" }
let s:palette.cyan           = { "gui": "#5fc0d2", "cterm": "38",   "cterm16": "6" }
let s:palette.white          = { "gui": "#c3d5e9", "cterm": "145",  "cterm16": "7" }
...
call s:h("cssProp", { "fg": s:palette.darkturquoise })
call s:h("cssAttr", { "fg": s:palette.yellow })
...
call s:h("jsObjectProp", { "fg": s:palette.yellow })
